...
echo_and_run cd "/home/ebrahim/TURTLEBOT3_controller/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ebrahim/TURTLEBOT3_controller/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/home/ebrahim/TURTLEBOT3_controller/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
